...
class AVLTree(BinarySearchTree, Generic[K, I]):
    ...
    def delete_aux(self, current: AVLTreeNode, key: K) -> AVLTreeNode:
        """
            ...
            :pre: Key corresponds to a valid, existent node within subtree
            :post: tree is rebalanced following deletion, heights are updated
            :raises ValueError: if key not found within subtree
            :complexity:
            :returns:
        """
